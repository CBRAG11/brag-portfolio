          ...
          <div className="inner">
            <div className="img-container">
              <img
                ...
                src="%PUBLIC_URL%/../images/profile3.png"
                alt=""
              />
            </div>
            <h2>
              <span>Clinton Braganza</span>
            </h2>
            <span>
              <ul className="icons">
                <li>
            ...
            <p>
              <span>Software Engineer | Petrolhead</span>
            </p>
            <p>
              <span>Arizona State University</span>
              <span> MS ISM - Data Analytics</span>
            </p>
            <ul className="actions special">
              <li>
                <a
                  href="%PUBLIC_URL%/../files/ClintonBraganza-Resume.pdf"
                  className="button "
                  download
                >
                  Resume
